...
Future<void> fetchReservations() async {
  ...
  children: [
    ...
    SearchTable<Map<String, String>>(
      ...
      searchableFields: ['reservationId', 'userName', 'bookTitle', 'preferredPickupDate', 'status'],
      getFieldValue: (item) => item.values.join(' '), // not really used in your search_admin.dart but required
                                  ...
                                  label: Checkbox(
                                    ...
                                    onChanged: (value) =>
                                        controller.toggleSelectAll(
                                            value, () => setState(() {})),
                                    activeColor: Colors
                                        .teal, // Change fill color to teal
                                  ),
                                ),
                                DataColumn(
                              ...
                              rows: List.generate(
                                ...
                                return DataRow(
                                  ...
                                  cells: [
                                    ...
                                    DataCell(Text(
                                        reservation['preferredPickupDate']!)),
                                                    ...
                                                    try {
                                                      ...
                                                      final response =
                                                        ...
                                                        data: {
                                                          'reservation_id':
                                                              int.parse(
                                                                  reservationId!), // ensure it's an int
                                                        },
                                                      );
